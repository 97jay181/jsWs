...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        /* 목차. 1. non-static method 호출하는 경우 */
        com.ohgiraffers.section01.method.Calculator calc = new com.ohgiraffers.section01.method.Calculator();

        int max = calc.maxNumberOf(10,30);

        System.out.println("10과 30중 더 큰 값은 ? = " + max);

        /* 목차. 2. static method 호출하는 경우 */
        int min = com.ohgiraffers.section01.method.Calculator.minNumberOf(10,30);
