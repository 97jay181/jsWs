...
public class Application {
    ...
    public static void main(String[] args) {
         ...
         *
         * 목차2. 객체 간 상호작용
         *  - 카레이서가 수신할 수 있는 메시지 (= 카레이서가 해야하는 일 또는 책임)
         *    1. 시동을 걸어라
         *    2. 엑셀레이터 페달을 밟아라
         *    3. 브레이크 페달을 밟아라
         *    4. 시동을 꺼라
         *  - 자동차가 수신할 수 있는 메시지 (= 자동차가 해야하는 일 또는 책임)
         *    1. 시동을 건다
         *    2. 앞으로 간다
         *    3. 멈춘다
         *    4. 시동을 끈다
         *
         * 목차3. 커뮤니케이션 다이어그램 작성(동적)
1. 시동 걸기
   ---------                           ----------                           --------
...
4. 시동 끄기
  ...
  ---------  <-------------------   ---------- <------------------     ---------
        ...
        /* 설명. 카레이서가 한명 등장합니다. */
        CarRacer tom = new CarRacer();

        /* 설명. 입력받은 메뉴에 따라 카레이서의 행동이 달라집니다.*/
        ...
        while(true) {
            ...
            switch (no) {
                case 1 :
                    tom.engineOn();
                    System.out.println("시동거는 프로그램 엮기");
                    break;
                case 2 :
                    tom.stepAccelerator();
                    break;
