...
public class OverloadingTest {
    ...
    /* 설명. 메소드 시그니처가 동일해서 컴파일 에러 발생 */
//    public void test() {}     // 에러

    /* 설명. 접근제한자에 따른 오버로딩 성립 확인 */
//    private void test() {}      // 에러 : 접근제한자는 메소드 시그니처에 포함되지 않는다

    /* 설명. 반환형에 따른 오버로딩 성립 확인*/
//    public int test() {return 0;} // 에러 : 반환형은 메소드 시그니처에 포함되지 않는다.

    /* 설명. 매개변수 유무(0개 또는 1개 이상)에 따른 오버로딩 성립 확인 */
    public void test(int num) {}        // 파라미터 선언부는 메소드 시그니처에 해당된다.
//    public void test(int ber) {}        // 에러 : 파라미터의 이름은 메소드 시그니처에 포함되지 않는다.

    /* 설명. 매개변수 개수(1개 이상인 것들)에 따른 오버로딩 성립 확인 */
    public void test(int num1, int num2) {}

    /* 설명. 매개변수 타입 변화에 따른 오버로딩 성립 확인 */
    public void test(int num1, String str1) {}

    /* 설명. 매개변수 순서에 따른 오버로딩 성립 확인 */
    public void test(String str1, int num1) {}

    /* 설명. 오버로딩(overloading) 개념은 매우 중요한 개념이므로 반드시 숙지할 수 있도록 해야한다!!
     *  뒤에서 배울 오버라이딩(overriding)과 개념을 비교하는 면접 질문이 단골 질문으로 출제되니
     *  오버라이딩 학습을 마친 후 두 개념을 비교해 특징을 잘 살펴보도록 한다.
     * */
