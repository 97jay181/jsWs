...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(p1.getInformation());        // Java 기본값으로 초기화됨.

        /* 설명. Product의 매개변수 있는 생성자를 호출해 인스턴스 생성 후 정보 출력 */
        Product p2 = new Product("15pro", "애플", "아이폰15Pro",2000000, new Date());
        System.out.println(p2.getInformation());

        /* 설명. Computer 기본 생성자로 인스턴스 생성 후 정보 출력 */
        Computer c1 = new Computer();
        System.out.println(c1.getInformation());

        /* 설명. Computer의 매개변수 있는 생성자를 호출해 인스턴스 생성 후 정보 출력 */
        Computer c2 = new Computer("퀄컴 스냅드래곤", 512, 16, "윈도우");
        System.out.println(c2.getInformation());

        /* 설명. Computer의 부모 필드도 함꼐 초기화하는 생성자를 호출해 인스턴스 생성 후 정보 출력 */
        Computer c3 = new Computer("15pro", "애플", "아이폰15Pro",2000000, new Date(),
                "퀄컴 스냅드래곤", 512, 16, "윈도우");
